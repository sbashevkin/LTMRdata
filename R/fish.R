...
#' @param sources Which data sources would you like included? Options include: "Baystudy", "Suisun", "FMWT", "SKT", "DJFMP", "EDSM", and "TMM".
...
fish<-function(sources,
  ...
  if(is.null(sources) | !all(sources%in%c("Baystudy", "Suisun", "FMWT", "SKT", "DJFMP", "EDSM", "TMM"))){
