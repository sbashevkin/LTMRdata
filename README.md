...
Data <- LTMRpilot(convert_lengths=TRUE,
                  ...
                  size_cutoff=40)
str(Data)
#> tibble [879,462 x 25] (S3: tbl_df/tbl/data.frame)
#>  $ Source          : chr [1:879462] "Suisun" "Suisun" "Suisun" "Suisun" ...
#>  $ Station         : chr [1:879462] "MZ2" "MZ2" "MZ2" "MZ2" ...
#>  $ Latitude        : num [1:879462] 38.1 38.1 38.1 38.1 38.1 ...
#>  $ Longitude       : num [1:879462] -122 -122 -122 -122 -122 ...
#>  $ Date            : POSIXct[1:879462], format: "2013-12-04" "2013-12-04" ...
#>  $ Datetime        : POSIXct[1:879462], format: "2013-12-04 13:03:00" "2013-12-04 13:03:00" ...
#>  $ Depth           : num [1:879462] 6.4 6.4 6.4 6.4 6.4 6.4 6.4 6.4 6.4 6.4 ...
#>  $ SampleID        : chr [1:879462] "Suisun 1" "Suisun 1" "Suisun 1" "Suisun 1" ...
#>  $ Method          : chr [1:879462] "Otter trawl" "Otter trawl" "Otter trawl" "Otter trawl" ...
#>  $ Tide            : chr [1:879462] "Flood" "Flood" "Flood" "Flood" ...
#>  $ Sal_surf        : num [1:879462] 4.83 4.83 4.83 4.83 4.83 ...
#>  $ Temp_surf       : num [1:879462] 11.8 11.8 11.8 11.8 11.8 11.8 11.8 11.8 11.8 11.8 ...
#>  $ Secchi          : num [1:879462] 49 49 49 49 49 49 49 49 49 49 ...
#>  $ Tow_duration    : num [1:879462] 10 10 10 10 10 10 10 10 10 10 ...
#>  $ Tow_area        : num [1:879462] 2007 2007 2007 2007 2007 ...
#>  $ Taxa            : chr [1:879462] "Morone saxatilis" "Morone saxatilis" "Morone saxatilis" "Dorosoma petenense" ...
#>  $ Length          : num [1:879462] 142.5 152.6 96.2 96.2 122.8 ...
#>  $ Count           : num [1:879462] 1 1 1 1 1 2 1 1 1 1 ...
#>  $ Length_NA_flag  : chr [1:879462] NA NA NA NA ...
#>  $ Notes_catch     : chr [1:879462] NA NA NA NA ...
#>  $ Notes_tow       : chr [1:879462] NA NA NA NA ...
#>  $ Tow_volume      : num [1:879462] NA NA NA NA NA NA NA NA NA NA ...
#>  $ Tow_direction   : chr [1:879462] NA NA NA NA ...
#>  $ Secchi_estimated: logi [1:879462] NA NA NA NA NA NA ...
#>  $ Cable_length    : num [1:879462] NA NA NA NA NA NA NA NA NA NA ...
```
