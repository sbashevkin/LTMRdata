...
str(Data)
#> tibble [1,131,279 x 26] (S3: tbl_df/tbl/data.frame)
#>  $ Length          : num [1:1131279] 126 135 130 85 90 100 95 78 127 113 ...
#>  $ Count           : num [1:1131279] 1 1 1 1 1 1 2 1 1 1 ...
#>  $ Notes_catch     : chr [1:1131279] NA NA NA NA ...
#>  $ Method          : chr [1:1131279] "Otter trawl" "Otter trawl" "Otter trawl" "Otter trawl" ...
#>  $ Station         : chr [1:1131279] "MZ2" "MZ2" "MZ2" "MZ2" ...
#>  $ Date            : POSIXct[1:1131279], format: "2013-12-04" "2013-12-04" ...
#>  $ Temp_surf       : num [1:1131279] 11.8 11.8 11.8 11.8 11.8 11.8 11.8 11.8 11.8 11.8 ...
#>  $ Secchi          : num [1:1131279] 49 49 49 49 49 49 49 49 49 49 ...
#>  $ Tide            : chr [1:1131279] "Flood" "Flood" "Flood" "Flood" ...
#>  $ Datetime        : POSIXct[1:1131279], format: "2013-12-04 13:03:00" "2013-12-04 13:03:00" ...
#>  $ Source          : chr [1:1131279] "Suisun" "Suisun" "Suisun" "Suisun" ...
#>  $ SampleID        : chr [1:1131279] "Suisun 1" "Suisun 1" "Suisun 1" "Suisun 1" ...
#>  $ Longitude       : num [1:1131279] -122 -122 -122 -122 -122 ...
#>  $ Latitude        : num [1:1131279] 38.1 38.1 38.1 38.1 38.1 ...
#>  $ Depth           : num [1:1131279] 6.4 6.4 6.4 6.4 6.4 6.4 6.4 6.4 6.4 6.4 ...
#>  $ Tow_duration    : num [1:1131279] 10 10 10 10 10 10 10 10 10 10 ...
#>  $ Notes_tow       : chr [1:1131279] NA NA NA NA ...
#>  $ Tow_area        : num [1:1131279] 2007 2007 2007 2007 2007 ...
#>  $ Taxa            : chr [1:1131279] "Morone saxatilis" "Morone saxatilis" "Hysterocarpus traskii" "Morone saxatilis" ...
#>  $ Sal_surf        : num [1:1131279] 4.83 4.83 4.83 4.83 4.83 ...
#>  $ Survey          : int [1:1131279] NA NA NA NA NA NA NA NA NA NA ...
#>  $ Tow_direction   : chr [1:1131279] NA NA NA NA ...
#>  $ Tow_volume      : num [1:1131279] NA NA NA NA NA NA NA NA NA NA ...
#>  $ Tow_status      : chr [1:1131279] NA NA NA NA ...
#>  $ Secchi_estimated: logi [1:1131279] NA NA NA NA NA NA ...
#>  $ Cable_length    : num [1:1131279] NA NA NA NA NA NA NA NA NA NA ...
```
