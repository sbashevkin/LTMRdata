...
data(Suisun)
str(Suisun)
#> Classes 'tbl_df', 'tbl' and 'data.frame':    155690 obs. of  19 variables:
...
Data <- LTMRpilot()
str(Data)
#> tibble [1,130,940 x 26] (S3: tbl_df/tbl/data.frame)
#>  $ Length          : num [1:1130940] 126 135 130 85 90 100 95 78 127 113 ...
#>  $ Dead            : chr [1:1130940] NA NA NA NA ...
#>  $ Count           : num [1:1130940] 1 1 1 1 1 1 2 1 1 1 ...
#>  $ Notes_catch     : chr [1:1130940] NA NA NA NA ...
#>  $ Method          : chr [1:1130940] "Otter trawl" "Otter trawl" "Otter trawl" "Otter trawl" ...
#>  $ Station         : chr [1:1130940] "MZ2" "MZ2" "MZ2" "MZ2" ...
#>  $ Date            : POSIXct[1:1130940], format: "2013-12-04" "2013-12-04" ...
#>  $ Temp_surf       : num [1:1130940] 11.8 11.8 11.8 11.8 11.8 11.8 11.8 11.8 11.8 11.8 ...
#>  $ Secchi          : num [1:1130940] 49 49 49 49 49 49 49 49 49 49 ...
#>  $ Tide            : chr [1:1130940] "Flood" "Flood" "Flood" "Flood" ...
#>  $ Datetime        : POSIXct[1:1130940], format: "2013-12-04 13:03:00" "2013-12-04 13:03:00" ...
#>  $ Source          : chr [1:1130940] "Suisun" "Suisun" "Suisun" "Suisun" ...
#>  $ Longitude       : num [1:1130940] -122 -122 -122 -122 -122 ...
#>  $ Latitude        : num [1:1130940] 38.1 38.1 38.1 38.1 38.1 ...
#>  $ Depth           : num [1:1130940] 6.4 6.4 6.4 6.4 6.4 6.4 6.4 6.4 6.4 6.4 ...
#>  $ Tow_duration    : num [1:1130940] 10 10 10 10 10 10 10 10 10 10 ...
#>  $ Notes_tow       : chr [1:1130940] NA NA NA NA ...
#>  $ Taxa            : chr [1:1130940] "Morone saxatilis" "Morone saxatilis" "Hysterocarpus traskii" "Morone saxatilis" ...
#>  $ Sal_surf        : num [1:1130940] 4.83 4.83 4.83 4.83 4.83 ...
#>  $ Survey          : int [1:1130940] NA NA NA NA NA NA NA NA NA NA ...
#>  $ Tow_direction   : chr [1:1130940] NA NA NA NA ...
#>  $ Tow_volume      : num [1:1130940] NA NA NA NA NA NA NA NA NA NA ...
#>  $ Tow_area        : num [1:1130940] NA NA NA NA NA NA NA NA NA NA ...
#>  $ Tow_status      : chr [1:1130940] NA NA NA NA ...
#>  $ Secchi_estimated: logi [1:1130940] NA NA NA NA NA NA ...
#>  $ Cable_length    : num [1:1130940] NA NA NA NA NA NA NA NA NA NA ...
```
